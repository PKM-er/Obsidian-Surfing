...
export default {
	...
	'Custom Link to Text Fragment Format': 'Custom Link to Text Fragment Format',
	'Copy Link to Text Fragment Format': 'Copy Link to Text Fragment Format',
	...
	'Open url in same tab': 'Open url in same tab',
	'Custom': 'Custom',
	'Baidu': 'Baidu',
	'Yahoo': 'Yahoo',
	'Bing': 'Bing',
	...
	'Copy Link to Text Fragment': 'Copy Link to Text Fragment',
