export default {
	...
	'Custom Link to Text Fragment Format': '自定义文本片段的链接的格式',
	'Copy Link to Text Fragment Format': '复制文本片段的链接的格式',
	...
	'Copy Link to Text Fragment': '复制文本链接',
