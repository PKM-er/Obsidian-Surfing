...
export class SurfingSettingTab extends PluginSettingTab {
    ...
    private addBookmarkManagerSettings(tabName: string, wbContainerEl: HTMLElement) {
        ...
        this.addSettingToMasterSettingsList(tabName, paginationSetting.settingEl, "pagination");
        ...
        this.addSettingToMasterSettingsList(tabName, defaultColumnList.settingEl, "default column list")
    }
}
